...
##
## Purpose:
##  A function that will generate a random sample fo normal values,
##     plot a histogram with an overlaid mean on the plot and returns 
##     summary statistics about the generated data
##
## Inputs:
